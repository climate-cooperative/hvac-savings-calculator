...
const furnace: OverridableComponent<SvgIconTypeMap<{}, 'svg'>> = (props: SvgIconProps) => (
...
const floor: OverridableComponent<SvgIconTypeMap<{}, 'svg'>> = (props: SvgIconProps) => (
  <SvgIcon {...props} viewBox="0 -10 50 50">
    <path
...
const raidant: OverridableComponent<SvgIconTypeMap<{}, 'svg'>> = (props: SvgIconProps) => (
  <SvgIcon {...props} viewBox="0 0 50 50">
    <style>
      {`.st7{fill:none;stroke:${props.color};stroke-linecap:round;stroke-miterlimit:10}`}
    </style>
    <path
...
const air_source: OverridableComponent<SvgIconTypeMap<{}, 'svg'>> = (props: SvgIconProps) => (
  <SvgIcon {...props} viewBox="0 0 50 50">
    <path
...
const geothermal: OverridableComponent<SvgIconTypeMap<{}, 'svg'>> = (props: SvgIconProps) => (
  <SvgIcon {...props} viewBox="0 0 50 50">
    <path 
...
const boiler: OverridableComponent<SvgIconTypeMap<{}, 'svg'>> = (props: SvgIconProps) => (
  <SvgIcon {...props} viewBox="0 0 50 50">
    <path
...
const space_heater: OverridableComponent<SvgIconTypeMap<{}, 'svg'>> = (props: SvgIconProps) => (
  <SvgIcon {...props} viewBox="0 0 50 50">
    <path
...
const stove: OverridableComponent<SvgIconTypeMap<{}, 'svg'>> = (props: SvgIconProps) => (
  <SvgIcon {...props} viewBox="0 0 50 50">
    <style>
      {
...
export { furnace, floor, raidant, air_source, geothermal, boiler, space_heater, stove };