...
const furnace: React.FC<IconProps> = ({ color }) => (
    <svg
...
const floor: React.FC<IconProps> = ({ color }) =>(
  <svg
  xmlns="http://www.w3.org/2000/svg"
  xmlSpace="preserve"
  id="Layer_1"
...
const raidant: React.FC<IconProps> = ({ color }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="Layer_1"
...
const air_source: React.FC<IconProps> = ({ color }) =>(
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="Layer_1"
...
const geothermal: React.FC<IconProps> = ({ color }) =>(
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    style={{
...
const boiler: React.FC<IconProps> = ({ color }) =>(
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="Layer_1"
...
const space_heater: React.FC<IconProps> = ({ color }) =>(
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="Layer_1"
...
const stove: React.FC<IconProps> = ({ color }) =>(
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="Layer_1"
